...
import chatbot from "../../assets/images/lottie/41617-chatbot.json"
const StickyChatBot = () => {
    ...
    return (
        <div className="chat-container">
            {!openChatBot ? (
                <button  onClick={() => setOPenChatBot(true)} className="border border-0 btn-secondary btn-below">
            <Lottie animationData={chatbot} loop={true} className={"LotieBtn"} />
                </button>
            ) : (
